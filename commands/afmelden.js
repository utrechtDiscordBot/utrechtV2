...
module.exports.run = async (bot, message, args) => {
    ...
    if(args[0], args[1] == null) {
        ...
        .setTitle("Gebruik")
        .setColor("#FF0000")
        .setDescription(`Meld je af door gebruik te maken van: \n !afmelden <TEAM> ${splitser} <DIENSTNUMMER>`);
   ...
   var dnrEmbed = new discord.RichEmbed()
    .setTitle("Afmelding:")
    .setColor("#FF0000")
    .setDescription(`Afmelding van: ${message.author} \n\n\n Team van afmelding: **${dnr2.team}** \n\n Dienstnummer: **${dnr2.dienstnummer}**`)
    .setTimestamp();
    ...
    .setTitle("Aanmelding")
    .setColor("#FF0000")
    .setDescription(`Hallo ${message.author}! Je bent succesvol afgemeld! \n Afmelding zien? Ga naar ${dnrKanaal}`);
